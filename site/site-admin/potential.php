...
$objU			=	new user();
 	...
 	if(isset($_POST['add']))
	{
		...
		{
	 	$Summary 			= 'Removed from potential client';
		$details			= 'Removed from potential client';
		}
		else
		{
		...
		/*		
			if($msg=="")
{*/
echo "<script language='javascript'>window.opener.location='potentialClient.php';</script>";
