...
<table width="380" border="0" cellpadding="0" cellspacing="0" style="background-color: #F7F7F7; border: 2px solid #FFFFFF; padding: 5px;">
	...
	?>
		...
		<tr><td style="padding-top: 0px;padding-bottom: 0px; font-family: arial, verdana, helvetica; font-size: 11px;width:80px;"></td>
	<td style="padding-top: 0px;padding-bottom: 0px; font-family: arial, verdana, helvetica; font-size: 11px;width:100px;"><nobr><input type="submit" value="  Upload  " style="font-size: 10px; width: 100%;"> (Max Filesize: <?php echo $phpmaxsize; ?>KB)</nobr></td>
		</tr>
	<?php
		}
		else {
