    ...
    */
	...
	addHoliday(26,1, 0, "Republic Day")
	addHoliday(15, 8, 0, "Independance Day")
	addHoliday(2, 10, 0, "Gandhi Jayanti")
	addHoliday(4, 11, 2002, "Deepawali")
	addHoliday(25, 12, 0, "Christmas Day")

    function ClearTextField(obj){
		obj.value = "";
	}
 	function ClearTextField2(obj){
