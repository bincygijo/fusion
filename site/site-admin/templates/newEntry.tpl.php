...
<table width="625" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="2">&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $listUser['Ref_no'];?><input type="hidden" name="ref_no" class="field2" value="<? echo $listUser['Ref_no'];?>" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Contact Person Name </td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $arrUser['name'];?><input type="hidden" name="contact_name" value="<? echo $arrUser['name'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">School Name</td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><?  echo $arrUser['school'];?><input type="hidden" name="school_name" value="<?  echo $arrUser['school'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">No.books required</td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><?  echo $listUser['client_order_books'];?><input type="hidden" name="no_books" value="<?  echo $listUser['client_order_books'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Editors Deadline </td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $listUser['client_order_deadline'];?><input type="hidden" name="editorS_dedline" id="editorS_dedline" value="<? echo $listUser['client_order_deadline'];?>" class="field2" />
                            <script language="javascript" src="js/datecal.js"></script></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Delivery Address</td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $listUser['client_order_del_addr'];?><input type="hidden" name="delivery_add" value="<? echo $listUser['client_order_del_addr'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Delivery Date</td>
                          <td></td>
                          <td colspan="3" class="tbtext"><?  $listUser['client_order_del_date'];?><input type="hidden" name="delivery_date" class="field2"  id="delivery_date" value="<?  $listUser['client_order_del_date'];?>" />
                            <script language="javascript" src="js/datecal.js"></script></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Contact Number </td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $arrUser['contact'];?><input type="hidden" name="contact_no" value="<? echo $arrUser['contact'];?>" class="field2" /></td>
                        </tr>
						 <tr>
                          <td class="tbtext">Email </td>
                          <td>&nbsp;</td>
                          <td colspan="3" class="tbtext"><? echo $arrUser['email'];?><input type="hidden" name="email" value="<? echo $arrUser['email'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">&nbsp;</td>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          <td colspan="5" class="tbtext"><table width="95%" border="0" cellpadding="2" cellspacing="0">
                            <tr>
                              ...
                              <td width="31"><!--<a href="javascript:;" name="AnchorTo" id="AnchorTo" onClick="popUpCalendar(form2.image1,document.getElementById('txtdate'), 'yyyy-mm-dd')"><img src="js/images/calendar.gif" alt="Date Selector" name="image1" width="20" height="23" hspace="3" border="0" align="absmiddle" id="image1" onMouseOver="window.status='Pop up a calendar to select a date';return true" onMouseOut="window.status='';return true;"></a><script language="javascript" src="js/datecal.js"></script>-->	<a href="javascript:showCal('Calendar5')"><img src="images/cal.gif" width="19" height="17" border="0" /></a></td>
			  ...
			  <? } ?>
                        ...
                        <tr>
                          ...
                          <td colspan="3"><br />
                              ...
                              <input type="image" name="submit" value="submit" src="images/save.gif" alt="" width="69" height="21" /><input type="hidden" name="clientId" id="clientId" value="<?php echo $_GET["id"]; ?>" />
