...
$delivery_date1			=	$date2[2]."/".$date2[1]."/".$date2[0];
 ...
 $state				=	$arrUser['state'];
  ...
  $book_type			=	$listProduct['booktype_id'];
 $despatch				=	$listProduct['product_dispatched'];
   ...
   $cover_designed		=	$listProduct['Cover_designed'];
	...
	$boohsent			=	$listProduct['books_sent'];
...
{
document.getElementById("txtHint25_1").innerHTML="New Supplier";
document.getElementById("txtHint25").innerHTML=xmlHttp.responseText ;
}else{
document.getElementById("txtHint25_1").innerHTML="";
document.getElementById("txtHint25").innerHTML="" ;
}
} 
} 
...
{ 
//alert(xmlHttp.responseText);
document.getElementById("booktypees").innerHTML=xmlHttp.responseText;
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="290" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td class="subhead">State :<? echo $state?></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td><a href="clientSheet.php?id=<? echo $uId;?>&code=I"><img src="images/customer_info.gif" alt="" width="269" height="47" border="0" /></a></td>
                                      </tr>
...
<!--<input type="text" name="refNumber" <? if($ref_id){?>value="<? echo $listUser['Ref_no']; ?>" <? }else { echo $random_number; }?> class="field"   />--><? //echo(rand(1000,10000)) ?><!--<input type="button" onclick="return gen_pwd2()" value="Generale" />--><!--<input type="text" name="textfield2" class="field" />--></td>
									...
									<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td class="tbtext"><div id="rateType_item">$<input type="text" name="baserate" id="baserate" class="field" value="<? echo $listAccount['client_basic_rate'];?>"  readonly=""/></div></td>
                                        </tr>
                                        <tr>
		...
		<? }
                                        ...
                                        <tr>
                                          <td class="tbtext">Book Type</td>
                                          <td>&nbsp;</td>
                                          <td class="tbtext"><div id="booktypees"><select class="listmenu" name="book_type" id="book_type" onChange="showId25(this.value)">
		<option value="">--- Select ---</option>
			<? if(!empty($arrBooktype))
		{
		foreach($arrBooktype as $key=>$value)
		{ ?>
		<option value="<?=$value['book_id']?>" <? if($book_type==$value['book_id']) echo 'selected';?> >
		 <?=$value['booktype']?></option>
		<? }
		}?>
		</select></div></td>
                                        </tr>
										
										 <tr><td class="tbtext"><div id="txtHint25_1"></div></td><td></td><td ><div id="txtHint25"></div></td></tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td class="tbtext">Books Sent &amp; Received</td>
                                          <td>&nbsp;</td>
                                          <td><input type="checkbox" name="booksreceive" id="booksreceive" <?PHP if($boohsent=='Y' ) {echo "checked";}?> value="Y" /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">&nbsp;</td>
                                          <td>&nbsp;</td>
...
?>
									...
									<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
                                      <tr>
                                        <td class="grouphead">Customer Information</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td class="tbtext">Name</td>
                                          <td width="2">&nbsp;</td>
                                          <td width="190"><input type="text" name="name" id="name" class="field" value="<?=$arrUser['name'];?>"    tabindex="1"/></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">Position</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="position" id="position" class="field" value="<?=$arrUser['positon'];?>"  /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">School </td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="school" id="school" class="field"  value="<?=$arrUser['school'];?>" /></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="street" id="street" class="field"  value="<?=$arrUser['street'];?>" size="45"/></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">Suburb</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="substreet" id="substreet" class="field"  value="<?=$arrUser['substreet'];?>" /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">Country</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="country" id="country" class="field"  value="<?=$arrUser['country'];?>" /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">State</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="state" id="state" class="field"  value="<?=$arrUser['state'];?>"/></td>
                                      </tr>
                                        <tr>
                                          <td class="tbtext">Postcode</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="postal" id="postal" class="field" value="<?=$arrUser['postal'];?>" /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">Best Contact Number</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="contact" id="contact" class="field" value="<?=$arrUser['contact'];?>" /></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">Email Address</td>
                                          <td>&nbsp;</td>
                                          <td><input type="text" name="email" id="email" class="field" value="<?=$arrUser['email'];?>" /></td>
                                        </tr>
                                        <tr>
                          ...
                          <tr>
                            <td align="center"><input type="image" name="add" value="Add" src="images/save.gif" alt="" width="69" height="21" />		  <img name="button" src="images/back.jpg" value="Go back" onClick="history.go(-1);" style="cursor:pointer"  />	
										  ...
										  <input type="hidden" name="add" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="image" name="order" src="images/order_form.gif" onclick="printopen();" /><!-- <a href="javascript:openPrint('printform.php?id=<?=$_GET["id"];?>')"><input type="image" name="order" src="images/order_form.gif" /></a>--> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="booksSent.php"><input type="image" name="books" src="images/book_sent.gif" border="0" /></a></td>
                          </tr>
                        </table></form>
						</td>
                    </tr>
...
mywindow	=	window.open("printform.php?id="+id,"mywindow","status=1,scrollbars=1,width=600,height=580");
				
mywindow.moveTo(600,580);	
//newurl = URL+"?id="+id;
//	aWindow=window.open(newurl,"theWindow","height=500,width=650,left=200,top=100,scrollbars=yes");
