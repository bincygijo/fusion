                                ...
                                <table width="569" border="0" align="center" cellpadding="2" cellspacing="0">
                                 <!-- <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="2">&nbsp;</td>
                                    <td width="439"><input type="text" name="name" id="name" class="field2"   size="45" value="<?=$arrContact['name'];?>"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Position</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="position" id="position" class="field2" value="<?=$arrContact['positon']?>"   size="45"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">School </td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="school" id="school" class="field2"  value="<?=$arrContact['school']?>" size="45"/></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="street" id="street" class="field2"  value="<?=$arrContact['street']?>" size="45"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Suburb</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="substreet" id="substreet" class="field2"  value="<?=$arrContact['substreet']?>" size="45"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Country</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="country" id="country" class="field2"  value="<?=$arrContact['country']?>" size="45"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">State</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="state" id="state" class="field2" value="<?=$arrContact['state']?>" /></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Postcode</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="postal" id="postal" class="field2" value="<?=$arrContact['postal']?>" /></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Best Contact Number</td>
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="contact" id="contact" value="<?=$arrContact['contact']?>" class="field2" /></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><textarea name="info" class="textarea"><?=$arrContact['information']?></textarea></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
