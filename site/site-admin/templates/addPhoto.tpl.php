                                ...
                                <table width="569" border="0" align="center" cellpadding="2" cellspacing="0">
                                 <!-- <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="2">&nbsp;</td>
                                    <td width="439"><input type="file" name="file" id="file" value=""   size="30" class="field1"/></td>
                                  </tr>
                                  <tr>
                                    <td class="tbtext">Pop-up Description </td>
                                    <td>&nbsp;</td>
                                    <td><textarea name="desc" class="textarea"><?php //echo $arrContact[0]['information']?></textarea></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td><input type="text" name="sc_name" class="field2" size="" /></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
...
{
alert("Please enter pop-up description");
...
if(document.form2.sc_name.value=="")
{
alert("Please enter  school name");
document.form2.sc_name.focus();
return false;
}
}
</script>
