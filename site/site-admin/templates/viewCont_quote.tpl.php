...
<?php 
$uId			=	$_GET['id'];
$listUser		=	$objU->getContact_qu($uId);
...
<table width="625" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          <td width="267" class="tbtext"> Name </td>
                          <td width="10">&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['school'];?><input type="hidden" name="contact_name" value="<?php  echo $listUser['name'];?>" class="field2" /></td>
                        </tr>
						
						 <tr>
                          <td class="tbtext">Email</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['email'];?><input type="hidden" name="email" value="<?php  echo $listUser['name'];?>" class="field2" /></td>
                        </tr>
						
                        <tr>
                          <td class="tbtext">No.Books</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['nobooks'];?><input type="hidden" name="school_name" value="<?php  echo $listUser['school'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">No.Pages</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['nopages'];?><input type="hidden" name="no_books" value="<?php  echo $listUser['no_books'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Budget  </td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['budget'] ;?><input type="hidden" name="editorS_dedline" id="editorS_dedline" value="<?php  echo $editor_date;?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Comments </td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['comments'];?><input type="hidden" name="delivery_add" value="<?php  echo $listUser['delivery_add'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Description</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?php  echo $listUser['description'];?></td>
                        </tr>
