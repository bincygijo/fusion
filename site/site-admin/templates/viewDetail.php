...
<table width="625" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="2">&nbsp;</td>
                          <td><input type="text" name="ref_no" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Contact Person Name </td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="contact_name" value="<?php echo $listUser['client_order_cpname'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">School Name</td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="school_name" value="<?php  echo $listUser['client_order_school'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">No.books required</td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="no_books" value="<?php  echo $listUser['client_order_books'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Editors Deadline </td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="editorS_dedline" id="editorS_dedline" value="<?php echo $listUser['client_order_deadline'];?>" class="field2" /><a href="javascript:;" name="AnchorTo" id="AnchorTo" onClick="popUpCalendar(form2.image3,document.getElementById('editorS_dedline'), 'dd-mm-yyyy')"><img src="js/images/calendar.gif" alt="Date Selector" name="image3" width="20" height="20" hspace="3" border="0" align="absmiddle" id="image3" onMouseOver="window.status='Pop up a calendar to select a date';return true" onMouseOut="window.status='';return true;"></a><script language="javascript" src="js/datecal.js"></script></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Delivery Address</td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="delivery_add" value="<?php echo $listUser['client_order_del_addr'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Delivery Date</td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="delivery_date" class="field2"  id="delivery_date" value="<?php echo $listUser['client_order_del_date'];?>" /><a href="javascript:;" name="AnchorTo" id="AnchorTo" onClick="popUpCalendar(form2.image2,document.getElementById('delivery_date'), 'dd-mm-yyyy')"><img src="js/images/calendar.gif" alt="Date Selector" name="image2" width="20" height="20" hspace="3" border="0" align="absmiddle" id="image2" onMouseOver="window.status='Pop up a calendar to select a date';return true" onMouseOut="window.status='';return true;"></a><script language="javascript" src="js/datecal.js"></script></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Contact Number </td>
                          <td>&nbsp;</td>
                          <td><input type="text" name="contact_no" value="<?php echo $listUser['client_order_contact'];?>" class="field2" /></td>
                        </tr>
                        <tr>
                          <td class="tbtext">&nbsp;</td>
                          <td>&nbsp;</td>
	...
	<option value="">Select one</option>
	 <?php if(!empty($arrEntry)) { ?>
			  <?php foreach($arrEntry as $key=>$value){?>
	 <option value="<?=$value['entry_id']?>" <?php if($entry==$value['entry_id']) echo 'selected';?> >
  ...
  <tr>
    <td height="57" background="images/footer_bg.gif" align="center"><?php include('footer.php')?></td>
  </tr>
</table>
</body>
</html>
