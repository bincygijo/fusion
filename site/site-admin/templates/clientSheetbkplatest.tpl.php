...
<!--<input type="text" name="refNumber" <? if($ref_id){?>value="<? echo $listUser['Ref_no']; ?>" <? }else { echo $random_number; }?> class="field"   />--><? //echo(rand(1000,10000)) ?><!--<input type="button" onclick="return gen_pwd2()" value="Generale" />--></td>
                                        ...
                                        <tr>
										 ...
										 <!-- <a href="javascript:;" name="AnchorTo" id="AnchorTo" onClick="popUpCalendar(form2.image3,document.getElementById('editorsDeadline'), 'yyyy-mm-dd')"><img src="js/images/calendar.gif" alt="Date Selector" name="image3" width="20" height="20" hspace="3" border="0" align="absmiddle" id="image3" onMouseOver="window.status='Pop up a calendar to select a date';return true" onMouseOut="window.status='';return true;"></a><script language="javascript" src="js/datecal.js"></script>--><a href="javascript:showCal('Calendar2')"><img src="images/cal.gif" width="19" height="17" border="0" /></a></td>
                                        </tr>
                                        <tr>
		...
		<? }
										...
										<!--  <a href="javascript:;" name="AnchorTo" id="AnchorTo" onClick="popUpCalendar(form2.image1,document.getElementById('sdat'), 'yyyy-mm-dd')"><img src="js/images/calendar.gif" alt="Date Selector" name="image1" width="20" height="20" hspace="3" border="0" align="absmiddle" id="image1" onMouseOver="window.status='Pop up a calendar to select a date';return true" onMouseOut="window.status='';return true;"></a><script language="javascript" src="js/datecal.js"></script>--><a href="javascript:showCal('Calendar1')"><img src="images/cal.gif" width="19" height="17" border="0" /></a></td>
                                        </tr>
										<tr>
                                        ...
                                        <tr>
                                          <td class="tbtext">&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td><input type="image" name="add" value="Add" src="images/save.gif" alt="" width="69" height="21" />		  <img name="button" src="images/back.jpg" value="Go back" onClick="history.go(-1);" style="cursor:pointer"  />	
										  
										  						  <input type="hidden" name="clientId" id="clientId" value="<?php echo $_GET["id"]; ?>" />
                                    ...
                                    <td width="350" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                        ...
                                        <tr>
                                          <td height="35" class="tbtext">Trial account expires on</td>
                                          <td class="tbtext">&nbsp;</td>
										...
										<? }
										  ...
										  </select> 		<a href="javascript:openWin('addrateType.php?id=<?=$uId;?>');">Add New</a>							  </td>
                                        </tr>
										<? 
									...
									$amt_receivd		= $amt + $depo;
						 			 $per		=	$total_amount*60/100;	
                                        ...
                                        <tr>
                                          ...
                                          <td class="tbtext">&nbsp;</td>
                                          <td class="tbtext">$<input type="" value="<?=number_format($total_amount,2);?>" name="total" id="total" class="field" readonly="" onfocus="calculate();"/></td>
                                        </tr>
                                        <tr>
                                          <td class="tbtext">60% Payment </td>
                                          <td class="tbtext">:</td>
                                          <td class="tbtext"> <? //=$editors_ded;?>
										  <?
										...
										/* if($amt_receivd >=$per && $depo>=300)
										 {*/
											...
											{
											echo "PAID"; ?>
											<a  href="clientSheet.php?pdfname=invoices/invoicepayment<?=$uId?>.pdf&pdf=pdf"><img src="images/pdf.gif" border="0"/></a>
											<? }
											else
											{
											echo "NOT PAID";?>  due before<?=$delivery_date1;?><a href="javascript:openWin('payment.php?id=<?=$uId;?>&aid=<?=$listAccount['client_account_id'];?>')">Due</a>
										 <? }*/
										// }
...
<table width="699" border="0">
  <tr>
    <td width="299" class="grouphead">Client History</td>
	<td width="154"><a href="newEntry.php?id=<?=$uId;?>" class="create">Create New Entry</a></td>
...
?>
  <tr>
    <td width="" class="tbtext2"><? echo $exp_His;?></td><td  class="tbtext2"><?=substr($value['history_summary'],0,30);?></td>
	<td  class="tbtext2"><?=substr($value['history_detail'],0,30);?></td>
    <td width="" class="tbtext2"><a href="historyDetail.php?hid=<?=$value['new_history_id']?>&id=<?=$uId?>">View Detail<? //$value['history_school'];?></a></td>
