...
$viewHistory	= $objH->viewhistory($cId);
?>
...
<table width="625" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          <td class="tbtext">Staff Name </td>
                          <td></td>
                          <td class="tbtext"><?=$viewHistory['history_staffname'];?></td>
                        </tr>
                        <tr>
                          <td class="tbtext">School </td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['history_school'];?></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Client Name</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['history_clientname'];?></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Entry Summary </td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['history_summary'];?></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Summary Details</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['history_detail'];?></td>
                        </tr>
                       
                        <tr>
                          <td class="tbtext">Transaction type</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['Transation_type'];?></td>
                        </tr>
                        <tr>
                          <td class="tbtext">Amount</td>
                          <td>&nbsp;</td>
                          <td class="tbtext"><?=$viewHistory['amount'];?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><br />
                             <!-- <input type="image" name="submit" value="submit" src="images/submit.gif" alt="" width="69" height="21" />--><input type="hidden" name="clientId" id="clientId" value="<?php echo $_GET["id"]; ?>" /><input type="hidden" name="clientId" id="clientId" value="<?php echo $_GET["id"]; ?>" /><input type="hidden" name="code" id="code" value="<?=$_GET['code'];?>" /></td>
                        </tr>
                      </table>
</form></td></tr>
                          <tr>
...
//window.location = "BuyingStep1.php?enquiryId="+enqId;
 	window.location = "clientSheet.php?id="+cId+"&code="+code1;
 }
</script>
