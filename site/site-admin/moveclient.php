...
$objU			=	new user();
 	...
 	if(isset($_POST['add']))
	{
		...
		{
	 	$Summary 			= 'move from potential client to current customers';
		$details			= 'move from potential client to current customers';
		}
		else
		{
		...
		$qry	=	mysql_query("update new_entry set entry_actionid=6  where client_id=$client_id[$i]");
	//	$msg			= 	$objE->deleteNewentry($client_id[$i],$action_id);	
						
		/*		
			if($msg=="")
{*/
echo "<script language='javascript'>window.opener.location='currentclient.php';</script>";
    ...
    <td>
      <table width="500" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr>
          <td class="tbtext">&nbsp;</td>
          <td>&nbsp;</td>
          <td height="35" valign="bottom"><input type="image" name="add" img src="images/submit.gif" alt="" width="69" height="21" onClick="function1();"/>&nbsp; <img name="button" src="images/close.jpg" value="Go back" onClick="window.close();"  style="cursor:pointer"/>
