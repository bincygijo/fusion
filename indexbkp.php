      ...
      <div id="aussie">
        ...
        <div class="middle-area">
		  ...
		  <div class="container gallery-container">
			...
			?>
			<div class="picture"><img src="site/site-admin/upload/<?=$value['photo_name']?>" alt="" width="65px" height="90px" /></div>
			<? 
			...
			?>
			<!--<div class="picture"><img src="images/book1.jpg" alt="" /></div>
			<div class="picture"><img src="images/book2.jpg" alt="" /></div>
			<div class="picture"><img src="images/book3.jpg" alt="" /></div>
			<div class="picture"><img src="images/book4.jpg" alt="" /></div>-->
			
			<? if(count($arrPhoto)>3){?>
			<div class="gallery-nav">
			<div class="arrow_right"><a href=""><img src="images/arrow_right.jpg" alt="" width="28" height="29" border="0" /></a></div>
			</div>
			<? }?>
          </div>
		  </div>
