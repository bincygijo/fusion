...
class Mail_IMAP {
    ...
    */
		...
		// This function set the portt
		// example popmail::set_port(110)
		function set_port($port)
		{
			$this->port=$port;
		}
		////This function is to retrive the error of last operation 
		...
		////This function is to retrive the state of connaction 
		function get_state()
		{
			return $this->state;
		}
    ...
    function connect($connect, $options = NULL)
    {
		...
		$connect .='/novalidate-cert'; // additionally added
        $connect .= '}';
...
/*$ret = (FALSE === ($this->mailbox = @imap_open("{www.litebreeze.com:143/IMAP/novalidate-cert}INBOX", "bini.gopalan@litebreeze.com", "bini123pw", $options)))? PEAR::raiseError('Mail_IMAP::connect: Unable to build a connection to the specified mail server.') : TRUE;
*/
    ...
    */
    function getHeaders(&$mid, $pid = '0', $from_length = 1, $subject_length = 1023, $default_host = NULL, $options = NULL)
    {
