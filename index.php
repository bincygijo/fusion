    ...
    <div id="column-left">
      <div class="login">
        ...
        <div class="middle">
          ...
          <form id="form2" name="form2" method="post" action="http://create.fusionbooks.com.au/User/login">
		  <label>
            <input type="text" name="username" id="username" class="textfield" value="Username" onclick="javascript:clearUsername();" /></label>
			<label>
             <input type="password" name="password" id="password" class="textfield" value="Password"  onclick="javascript:clearPass();"  /></label>
	...
	<div class="bubble_bottom"></div>
		...
		<li id="view">
			...
			//	$tvalue =str_replace("<br />","",$tvalue);
				...
				$path	=	'site/site-admin/upload/'.$value['photo_name'];
				
				$img		=	$value['photo_name'];
				
				 if(!file_exists($path))
				{
				
			$path	=	'site/site-admin/upload/no_image.gif';
			$img		=	'no_image.gif';
				}
				...
				<div style="float:left; width: 30px; height:80px; margin:0; padding:0;"> 
				<a href="#" onmouseover="showToolTip(event,'<? echo $tvalue ?>');return false" onmouseout="hideToolTip()">
				 <img style="vertical-align:middle;<?=$img_dimn; ?>" align="absmiddle" src="site/site-admin/upload/<?=$img;?>" alt="" /></a></div>
				 <div style="float:left; width:200px;"><span class="quotes">&ldquo;</span><? echo $d;?><span class="quotes">&rdquo;</span></div>
				 <div style="float:left; width:200px; text-align:right;"><? echo $school_name;?></div>
				</div>
		...
		<?php	} }else{?>
			<li><img  src="images/front_cover8.jpg" alt="" width="65px" height="90px" border="0" /></li>	<?php }?>
			</ul>
		</li>
...
function clearPass()
			...
			function fillPass()
			{
				...
				var doc = document.getElementById("password").value ;
